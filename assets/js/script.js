(function($){
    ...
    window.addEventListener('DOMContentLoaded', function () {
        ...
        demo = window.typeformEmbed.makePopup('https://pummel.typeform.com/to/KYuHTG', {
            mode: 'drawer_right',
            hideHeaders: true,
            hideFooter: true
        });
    ...
    document.getElementById('bt-demo-nav').addEventListener('click', function () {
        demo.open();
    });
    document.getElementById('bt-demo').addEventListener('click', function () {
        demo.open();
    });
